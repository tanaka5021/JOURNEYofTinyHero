...
public class EnemyStatus : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        beatEnemy = Sword.GetComponent<BeatEnemy>();
    ...
    void Update()
    {
        ...
        if (beatEnemy.isAttacked1 == true)
        {
            ...
            SetHp1(hp1);
            beatEnemy.isAttacked1 = false;
        }

        if (beatEnemy.isAttacked2 == true)
        {
            //設定した攻撃力をHPから減らす
            hp2 = hp2 - attackPower;
            ...
            SetHp2(hp2);
            beatEnemy.isAttacked2 = false;
        }

        if (beatEnemy.isAttacked3 == true)
        {
            //設定した攻撃力をHPから減らす
            hp3 = hp3 - attackPower;
